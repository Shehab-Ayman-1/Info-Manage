    ...
    return (
        <Fragment>
            ...
            <div className="grid grow grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2 xl:grid-cols-3">
                ...
                <SubscriptionCard heading="Premium" features={premium} costs={{ month: 100, year: 1100 }} />
                <SubscriptionCard heading="Enterprise" features={enterprise} costs={{ month: 100, year: 1100 }} />
            </div>
        </Fragment>
    );
};
